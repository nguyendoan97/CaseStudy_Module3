...
<div class="container-fluid">
    <div class="row">
        <div class="col-3" style="position: fixed;font-size: 18px">
...
<%--                              %>--%>
        ...
        <div class="col-9" style="margin-left: 300px">
            <img style="margin-top: 100px" src="http://doancode.mobie.in/hang-moi-ve-1.jpg" height="80" width="100%"/>
            <div class="row">
                    <c:forEach items="${listProduct}" var="product">
                        <div class="col-sm-3 poly-prod" style="margin: 30px;margin-left:20px ">
                        <div class="card card-default" style="margin-left: 40px;margin-right: 40px;width: 260px">
                            <div class="card-body" style="padding: 0">
                                <img src="${product.image}" width="260px" height="330px" alt="Ảnh"/>
                                <div id="nut">
                                    <button type="submit" style="margin-top: -50px;margin-left: 168px;">
                                        <a style="text-decoration: none ; color: white" href="/cart?action=cart&id=${product.id}">Đặt Hàng</a></button>
                                    <button type="submit" style="margin-top: -50px;margin-left: 90px;">
                                        <a style="text-decoration: none ; color: white" href="/products?action=view&id=${product.id}">Chi Tiết</a>
                                    </button>
                                </div>
                            </div>
